...
public class theVariantDetection extends Configured implements Tool {

    public static class theVariantDetectionMapper extends Mapper<Object, Text, Text, Text> {
        ...
        public void map(Text key, Text value, Context context) throws IOException, InterruptedException {
            ...
            try {
                DNASeq.theVariantDetectionMapper(value.toString());
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public int run(String[] args) throws Exception {
        ...
        if (args.length != 2) {
            System.err.println("Usage: theVariantDetection <input file> <output path>");
            System.exit(-1);
        }
        ...
        Job job = new Job(conf, "VariantDetection");
        job.setJarByClass(theVariantDetectionMapper.class);


        job.setInputFormatClass(NLineInputFormat.class);
        job.setMapperClass(theVariantDetectionMapper.class);
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new theVariantDetection(), args);
